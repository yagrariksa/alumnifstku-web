...
<html lang="en" class="no-focus">
    <head>
        ...
        <title>AlumniFSTku Admin | @yield('title')</title>
    ...
    <body>
        ...
        -->
        <div id="page-container" class="sidebar-mini sidebar-o sidebar-inverse enable-page-overlay side-scroll page-header-fixed main-content-narrow">
            <!-- Sidebar -->
            <!--
                Helper classes
                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-header content-header-fullrow px-15">
                        ...
                        <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                            ...
                            <div class="content-header-item">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-hero btn-alt-primary" data-toggle="layout" data-action="sidebar_style_inverse_toggle">
                                    <i class="fa fa-moon-o mr-10"></i> Switch Theme
                                </a>
                            </div>
                            <!-- END Logo -->
                        </div>
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            <!-- Dashboard -->
                            <li>
                                <a class="nav-item-sidebar" id="dashboard" href="{{route('dashboard.index')}}"><i class="si si-cup"></i><span class="sidebar-mini-hide">Dashboard</span></a>
                            </li>
                            <!-- END Dashboard -->
                            <!-- Alumni -->
                            ...
                            {{-- <li>
                                <a class="nav-item-sidebar" id="alumni-search" href="#"><i class="si si-magnifier"></i><span class="sidebar-mini-hide">Cari Alumni</span></a>
                            </li> --}}
                            <!-- END Alumni -->
                            <!-- Info Loker -->
                            <li class="nav-main-heading">
                                <span class="sidebar-mini-visible">ILK</span>
                            ...
                            <li class="nav-main-heading">
                                ...
                                <span class="sidebar-mini-hidden">FST News</span>
                            </li>
                            <li>
                                <a class="nav-item-sidebar" id="news-create" href="{{route('news.create')}}"><i class="si si-docs"></i><span class="sidebar-mini-hide">Tambah Berita</span></a>
                            </li>
                            <li>
                            ...
                            {{-- <li class="nav-main-heading">
                                ...
                                <span class="sidebar-mini-hidden">Sharing Memory</span>
                            </li> --}}
                            <!-- END Sharing Memory -->
                            <!-- Kelas Alumni -->
                            <li class="nav-main-heading">
                                <span class="sidebar-mini-visible">KA</span>
                            ...
                            <!-- Akun -->
                            <li class="nav-main-heading">
                                <span class="sidebar-mini-visible">AK</span>
