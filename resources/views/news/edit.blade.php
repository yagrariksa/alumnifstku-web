...
<div class="block">
    ...
    <div class="block">
        <div class="block-content">
            <form class="js-validation-material" action="{{route('news.update', $news->id)}}" method="post">
                @csrf
                <div class="form-group @error('judul') is-invalid @enderror">
                    <div class="form-material">
                        <input type="text" class="form-control" id="judul" name="judul" value="{{old('judul') == null ? $news->judul : old('judul')}}">
                ...
                <div class="form-group @error('link') is-invalid @enderror">
                    <div class="form-material">
                        <input type="text" class="form-control" id="link" name="link" value="{{old('link') == null ? $news->link : old('link')}}">
                ...
                <div class="form-group @error('gambar') is-invalid @enderror">
                    <div class="form-material">
                        <input type="text" class="form-control" id="gambar" name="gambar" value="{{old('gambar') == null ? $news->gambar : old('gambar')}}">
