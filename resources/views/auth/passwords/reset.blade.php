...
<head>
    ...
    <title>AlumniFSTku - Web Admin | Masuk</title>

    <meta name="description" content="AlumniFSTku - Web Admin | Masuk">
    <meta name="author" content="AlumniFSTku">
    <meta name="robots" content="noindex, nofollow">

    <!-- Open Graph Meta -->
    <meta property="og:title" content="AlumniFSTku - Web Admin | Masuk">
    <meta property="og:site_name" content="AlumniFSTku">
    <meta property="og:description" content="AlumniFSTku - Web Admin | Masuk">
                    ...
                    <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                        <div class="p-30 invisible" data-toggle="appear">
                            <p class="font-size-h3 font-w600 text-white">
                                <i class="fa fa-bell"></i> re-register your password
                            </p>
                        ...
                        <div class="content content-full">
                            ...
                            <div class="px-30 pt-10 pb-30">
                                {{-- <a class="link-effect text-pulse font-w700" href="index.php">
                                    ...
                                    <span class="font-size-xl text-pulse-dark">code</span><span
                                        class="font-size-xl">base</span>
                                </a> --}}
                                <h1 class="h3 font-w700 mt-30 mb-10">Welcome back, {{ $email ?? old('email') }}</h1>
                            ...
                            <form class="js-validation-lock px-30" action="{{ route('password.update') }}"
                                method="post">
                                @csrf
                                ...
                                <div class="form-group row  @error('password') is-invalid @enderror">
                                    <div class="col-12">
                                        <div class="form-material floating">
                                            ...
                                            <label for="new-password">{{ __('Password') }}</label>
                                        </div>
                                        @error('password')
                                            <div id="new-password-error" class="invalid-feedback animated fadeInDown">
                                                {{ $message }}
                                            </div>
                                        @enderror
                                    </div>
...
-->
    ...
    <!-- Page JS Code -->
    <script src="{{ url('assets/js/pages/op_auth_lock.min.js') }}"></script>
