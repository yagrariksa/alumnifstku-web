        ...
        <div class="block-content">
            <form class="js-validation-material" action="{{route('loker.store')}}" method="post">
                ...
                <div class="form-group @error('deskripsi') is-invalid @enderror">
                    <div class="form-material floating">
                        <textarea rows="4" type="text" class="form-control" id="deskripsi" name="deskripsi" >{{old('deskripsi')}}</textarea>
                ...
                <div class="form-group @error('cluster') is-invalid @enderror">
                    <div class="form-material floating">
                        <input rows="4" type="text" class="form-control" id="cluster" name="cluster" value="{{old('cluster')}}">
                ...
                <div class="form-group @error('jurusan') is-invalid @enderror">
                    <div class="form-material floating">
                        <input rows="4" type="text" class="form-control" id="jurusan" name="jurusan" value="{{old('jurusan')}}">
